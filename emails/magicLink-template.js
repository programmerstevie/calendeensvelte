...
<body style="word-spacing:normal;">
  ...
  <div style="" lang="und" dir="auto">
    ...
    <div style="background:#f9fafb;background-color:#f9fafb;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#f9fafb;background-color:#f9fafb;width:100%;">
        <tbody>
          <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-bottom:10px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;text-transform:uppercase;color:#4f46e5;">${props.appName}</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size:0px;padding:12px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-weight:normal;line-height:24px;text-align:center;color:#111827;">Sign in to <strong style="font-weight: bold;">${props.appName}</strong><br /> to ${props.actionDescription}</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" class="button" style="font-size:0px;padding:20px;word-break:break-word;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:150px;line-height:100%;">
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#4f46e5" role="presentation" style="border:none;border-radius:8px;cursor:auto;height:60px;mso-padding-alt:10px 25px;background:#4f46e5;" valign="middle">
                                <a href="${props.signInLink}" style="display:inline-block;width:100px;background:#4f46e5;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:8px;" target="_blank"> SIGN IN </a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:20px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#6b7280;">If you didn't request this email, you can safely ignore it.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#6b7280;">If you believe you received this email by mistake, please contact our support team<br /><a href="mailto:${props.supportEmail}" style="color: #4f46e5;">${props.supportEmail}</a>.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:12px;line-height:1;text-align:center;color:#6b7280;">© ${props.year} ${props.appName}, All rights reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
